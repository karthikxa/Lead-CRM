...
async function deployAntiSpamAndLuxury() {
  ...
  console.log('2. Deploying updated email service and template into container...');
...
deployAntiSpamAndLuxury().catch(console.error);
